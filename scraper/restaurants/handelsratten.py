"""Restaurang Handelsrätten — Nordrest campus restaurant at Handelshögskolan (GU).

Same Castit menu widget as the other hors.se (Högskolerestauranger / Nordrest)
restaurants: the weekly menu is server-rendered as one
`div.castit-weekpanel[data-week]` per published week with a
`section.castit-day` per weekday (dish title + description elements).
"""
...
RESTAURANT = Restaurant(
    id="handelsratten",
    name="Restaurang Handelsrätten",
    address="Vasagatan 1",
    url="https://www.hors.se/goteborg/17/2/restaurang-handelsratten/",
    menu_url="https://www.hors.se/goteborg/17/2/restaurang-handelsratten/",
    walk_minutes=20,
    cuisine="Varierat",
    price="",
